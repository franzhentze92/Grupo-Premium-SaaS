...
const responsables = ['Todos', 'Carlos Ramírez', 'Ana Martínez', 'Luis González', 'María Rodríguez'];
const estados = ['Todos', 'Completada', 'En Progreso', 'Pendiente'];
const prioridades = ['Todas', 'Alta', 'Media', 'Baja'];

const tareas = [
  { id: 1, titulo: 'Prospección clientes potenciales Q2', responsable: 'Carlos Ramírez', estado: 'Completada', prioridad: 'Alta', fecha: '2024-05-10', inicio: '2024-05-01', fin: '2024-05-10' },
  { id: 2, titulo: 'Negociación contrato proyecto residencial', responsable: 'Ana Martínez', estado: 'En Progreso', prioridad: 'Alta', fecha: '2024-05-12', inicio: '2024-05-08', fin: '2024-05-12' },
  { id: 3, titulo: 'Cierre venta proyecto comercial', responsable: 'Luis González', estado: 'Pendiente', prioridad: 'Media', fecha: '2024-05-14', inicio: '2024-05-13', fin: '2024-05-14' },
  { id: 4, titulo: 'Seguimiento post-venta clientes premium', responsable: 'María Rodríguez', estado: 'En Progreso', prioridad: 'Baja', fecha: '2024-05-15', inicio: '2024-05-12', fin: '2024-05-15' },
  { id: 5, titulo: 'Presentación propuesta a stakeholders', responsable: 'Carlos Ramírez', estado: 'Pendiente', prioridad: 'Alta', fecha: '2024-05-16', inicio: '2024-05-15', fin: '2024-05-16' },
  { id: 6, titulo: 'Capacitación equipo ventas', responsable: 'Ana Martínez', estado: 'En Progreso', prioridad: 'Media', fecha: '2024-05-17', inicio: '2024-05-14', fin: '2024-05-17' },
  { id: 7, titulo: 'Demo producto cliente potencial', responsable: 'Luis González', estado: 'Pendiente', prioridad: 'Alta', fecha: '2024-05-18', inicio: '2024-05-16', fin: '2024-05-18' },
  { id: 8, titulo: 'Revisión metas ventas mensual', responsable: 'María Rodríguez', estado: 'Completada', prioridad: 'Media', fecha: '2024-05-19', inicio: '2024-05-17', fin: '2024-05-19' },
];

const kpiCards = [
  { label: 'Tareas Totales', value: tareas.length, color: 'info', icon: ListChecks, trend: '+4 este mes', trendDir: 'up', secondary: 'Total registradas' },
  ...
  { label: 'En Progreso', value: tareas.filter(t => t.estado === 'En Progreso').length, color: 'warning', icon: LineChart, trend: '+2', trendDir: 'up', secondary: 'Actualmente activas' },
...
const DepartamentoVentasTareas: React.FC = () => {
  ...
  return (
    <div className="space-y-8 p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-2">
        ...
        <p className="text-gray-600">Gestión y seguimiento de tareas del departamento de ventas</p>
      </div>
      {/* KPI Cards */}
...
export default DepartamentoVentasTareas; 