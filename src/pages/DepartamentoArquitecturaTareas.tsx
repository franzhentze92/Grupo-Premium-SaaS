...
const responsables = ['Todos', 'Carlos Mendoza', 'Ana Rodríguez', 'Luis Fernández'];
const estados = ['Todos', 'Completada', 'En Progreso', 'Pendiente'];
const prioridades = ['Todas', 'Alta', 'Media', 'Baja'];

const tareas = [
  { id: 1, titulo: 'Diseño de planos - Residencial Vista Sur', responsable: 'Carlos Mendoza', estado: 'En Progreso', prioridad: 'Alta', fecha: '2024-06-10', inicio: '2024-06-01', fin: '2024-06-10' },
  { id: 2, titulo: 'Revisión de proyectos - Torre Premium', responsable: 'Ana Rodríguez', estado: 'Pendiente', prioridad: 'Media', fecha: '2024-06-12', inicio: '2024-06-11', fin: '2024-06-12' },
  { id: 3, titulo: 'Coordinación con ingenieros', responsable: 'Luis Fernández', estado: 'Completada', prioridad: 'Alta', fecha: '2024-06-08', inicio: '2024-06-05', fin: '2024-06-08' },
  { id: 4, titulo: 'Presentación de diseños', responsable: 'Carlos Mendoza', estado: 'En Progreso', prioridad: 'Baja', fecha: '2024-06-15', inicio: '2024-06-13', fin: '2024-06-15' },
  { id: 5, titulo: 'Desarrollo de conceptos', responsable: 'Ana Rodríguez', estado: 'Pendiente', prioridad: 'Media', fecha: '2024-06-18', inicio: '2024-06-17', fin: '2024-06-18' },
];
...
const DepartamentoArquitecturaTareas: React.FC = () => {
...
export default DepartamentoArquitecturaTareas; 