...
const eventTypeData = [
  { name: 'Reuniones', value: 8, fill: '#3b82f6' },
  { name: 'Gestión RRHH', value: 6, fill: '#f59e0b' },
  { name: 'Documentación', value: 5, fill: '#ef4444' },
  { name: 'Proveedores', value: 4, fill: '#10b981' },
                        ...
                        .map(event => (
                          <div
                            ...
                            className={`p-3 rounded-lg border-l-4 cursor-pointer hover:shadow-md transition-shadow ${
                              ...
                              event.type === 'hr' ? 'bg-yellow-50 border-yellow-400' :
                              event.type === 'documentation' ? 'bg-green-50 border-green-400' :
                              event.type === 'supplier' ? 'bg-red-50 border-red-400' :
                              event.type === 'office' ? 'bg-purple-50 border-purple-400' :
