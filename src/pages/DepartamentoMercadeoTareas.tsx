...
const responsables = ['Todos', 'Laura Martínez', 'Diego Ramírez', 'Ana Sánchez', 'Carlos López'];
const estados = ['Todos', 'Completada', 'En Progreso', 'Pendiente'];
const prioridades = ['Todas', 'Alta', 'Media', 'Baja'];

const tareas = [
  { id: 1, titulo: 'Diseñar campaña digital Q2', responsable: 'Laura Martínez', estado: 'Completada', prioridad: 'Alta', fecha: '2024-05-10', inicio: '2024-05-01', fin: '2024-05-10' },
  { id: 2, titulo: 'Crear contenido redes sociales', responsable: 'Diego Ramírez', estado: 'En Progreso', prioridad: 'Alta', fecha: '2024-05-12', inicio: '2024-05-08', fin: '2024-05-12' },
  { id: 3, titulo: 'Analizar métricas campaña anterior', responsable: 'Ana Sánchez', estado: 'Pendiente', prioridad: 'Media', fecha: '2024-05-14', inicio: '2024-05-13', fin: '2024-05-14' },
  { id: 4, titulo: 'Actualizar estrategia de marca', responsable: 'Laura Martínez', estado: 'En Progreso', prioridad: 'Baja', fecha: '2024-05-15', inicio: '2024-05-12', fin: '2024-05-15' },
  { id: 5, titulo: 'Preparar presentación para stakeholders', responsable: 'Carlos López', estado: 'Pendiente', prioridad: 'Alta', fecha: '2024-05-16', inicio: '2024-05-15', fin: '2024-05-16' },
  { id: 6, titulo: 'Optimizar SEO sitio web', responsable: 'Diego Ramírez', estado: 'En Progreso', prioridad: 'Media', fecha: '2024-05-17', inicio: '2024-05-14', fin: '2024-05-17' },
  { id: 7, titulo: 'Coordinación con agencia publicitaria', responsable: 'Ana Sánchez', estado: 'Pendiente', prioridad: 'Alta', fecha: '2024-05-18', inicio: '2024-05-16', fin: '2024-05-18' },
  { id: 8, titulo: 'Revisar presupuesto marketing', responsable: 'Carlos López', estado: 'Completada', prioridad: 'Media', fecha: '2024-05-19', inicio: '2024-05-17', fin: '2024-05-19' },
];

const kpiCards = [
  { label: 'Tareas Totales', value: tareas.length, color: 'info', icon: ListChecks, trend: '+3 este mes', trendDir: 'up', secondary: 'Total registradas' },
...
const DepartamentoMercadeoTareas: React.FC = () => {
  ...
  return (
    <div className="space-y-8 p-6 bg-gray-50 min-h-screen">
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-2">
        ...
        <p className="text-gray-600">Gestión y seguimiento de tareas del departamento de mercadeo</p>
      </div>
      {/* KPI Cards */}
...
export default DepartamentoMercadeoTareas; 