...
const categoryData = [
  { name: 'Gestión de Personal', value: 35, fill: '#1e3269' },
  { name: 'Documentación', value: 25, fill: '#fbbf24' },
  { name: 'Administración de Oficina', value: 20, fill: '#eab308' },
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={300}>
                  <RechartsLineChart data={administrativeTrendData}>
                    ...
                    <Tooltip />
                    <Legend />
                    <Line type="monotone" dataKey="activities" stroke="#1e3269" strokeWidth={2} name="Actividades" />
            ...
            <CardContent>
              <ResponsiveContainer width="100%" height={400}>
                <RechartsAreaChart data={administrativeTrendData}>
                  ...
                  <Tooltip />
                  <Legend />
                  <Area type="monotone" dataKey="activities" stackId="1" stroke="#1e3269" fill="#1e3269" fillOpacity={0.6} />
        ...
        <TabsContent value="detailed" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="bg-white shadow-sm border border-gray-200">
              <CardHeader>
                <CardTitle className="text-lg text-gray-800 flex items-center gap-2">
                  <Clipboard className="text-[#1e3269]" />
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-lg font-bold text-[#1e3269]">{metrics.documentAccuracy}%</span>
                  </div>
